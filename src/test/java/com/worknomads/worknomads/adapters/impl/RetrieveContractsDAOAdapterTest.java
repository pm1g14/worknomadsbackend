...
public class RetrieveContractsDAOAdapterTest {
    ...
    public void validateOrEmptyOptional_shouldReturnExpectedDOForValidInput() {
        Optional<RetrievedContractDO> actual = daoAdapter.validateOrEmptyOptional("a", "b", "c", "Monthly", new BigInteger("100000"), new BigInteger("1000000"), true);
        var expected = new RetrievedContractDO(
                "a", "b", "c", ContractPaymentTerm.Monthly, 100000.0, 1000000.0, true);
    ...
    public void validateOrEmptyOptional_shouldReturnEmptyOptionalForMissingName() {
        Optional<RetrievedContractDO> actual = daoAdapter.validateOrEmptyOptional("", "b", "c", "Monthly", new BigInteger("100000"), new BigInteger("1000000"), true);
        Assertions.assertFalse(actual.isPresent());
    }

    @Test
    public void validateOrEmptyOptional_shouldReturnEmptyOptionalForMissingSurname() {
        Optional<RetrievedContractDO> actual = daoAdapter.validateOrEmptyOptional("a", "", "c", "Monthly", new BigInteger("100000"), new BigInteger("1000000"), true);
        Assertions.assertFalse(actual.isPresent());
    }
    ...
    public void validateOrEmptyOptional_shouldReturnEmptyOptionalForMissingTerm() {
        Optional<RetrievedContractDO> actual = daoAdapter.validateOrEmptyOptional("a", "b", "c", "", new BigInteger("100000"), new BigInteger("1000000"), true);
        Assertions.assertFalse(actual.isPresent());
    }

    @Test
    public void validateOrEmptyOptional_shouldReturnEmptyOptionalForMissingSalary() {
        Optional<RetrievedContractDO> actual = daoAdapter.validateOrEmptyOptional("a", "b", "c", "Monthly", BigInteger.ZERO, new BigInteger("1000000"), true);
        Assertions.assertFalse(actual.isPresent());
    }

    @Test
    public void validateOrEmptyOptional_shouldReturnExpectedDOForZeroContractBalance() {
        Optional<RetrievedContractDO> actual = daoAdapter.validateOrEmptyOptional("a", "b", "c", "Monthly", new BigInteger("100000"), BigInteger.ZERO, true);
        var expected = new RetrievedContractDO(
                "a", "b", "c", ContractPaymentTerm.Monthly, 100000.0, 0.0, true);
        Assertions.assertEquals(actual.get().getEmployeeEmail(), expected.getEmployeeEmail());
        Assertions.assertEquals(actual.get().getEmployeeName(), expected.getEmployeeName());
        Assertions.assertEquals(actual.get().getEmployeeSur(), expected.getEmployeeSur());
        Assertions.assertEquals(actual.get().getNextPaymentAmount(), expected.getNextPaymentAmount());
    ...
    public void validateOrEmptyOptional_shouldReturnEmptyOptionalForInvalidPaymentTerm() {
        Optional<RetrievedContractDO> actual = daoAdapter.validateOrEmptyOptional("a", "b", "c", "M", new BigInteger("100000"), BigInteger.ZERO, true);
        Assertions.assertFalse(actual.isPresent());
    }
}
