...
public class ContractDetailsDO {
    ...
    public ContractDetailsDO(ZonedDateTime contractExpiry, Locale remoteLocation, double grossSalary, int paymentInstallments, ContractPaymentTerm paymentTerm) {
